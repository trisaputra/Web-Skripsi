    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
                        ...
                        <div class="col-md-12">
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data Penduduk
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tabelku">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%; text-align: center; vertical-align: middle"> NIK </th>
                                                    <th style="text-align: center; vertical-align: middle"> Nama Penduduk </th>
                                                    <th style="width: 15%; text-align: center; vertical-align: middle"> Kecamatan </th>
                                                    <th style="width: 15%; text-align: center; vertical-align: middle"> Kelurahan </th>
                                                    <th style="width: 13%; text-align: center; vertical-align: middle"> No HP </th>
                                                    <th style="width: 15%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_penduduk" data-toggle="modal" class="btn btn-sm btn-circle btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_penduduk" class="modal fade" aria-hidden="true">
                                        <div class="modal-dialog modal-detail">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="widget-box widget-color-red2">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title lighter smaller">Tambah Penduduk</h4>
                                                        </div>
                                                        <hr>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    ...
                                                                                    <input type="number" id="nik" name="nik" class="form-control" autocomplete="off" placeholder="Masukkan NIK"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" id="nama_penduduk" name="nama_penduduk" class="form-control" autocomplete="off" placeholder="Masukkan Nama Penduduk"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" autocomplete="off" placeholder="Masukkan Tempat Lahir"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-5">
                                                                                    <div class="input-group date date-picker-insert" data-date-format="dd-mm-yyyy">
                                                                                        <input type="text" class="form-control" name="tgl_lahir" id="tgl_lahir" readonly placeholder="Tanggak Lahir (Exp. dd-mm-yyyy)">
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                $('#mnm_penduduk').addClass('active');

                $('.date-picker-insert').datepicker({
                    rtl: App.isRTL(),
                    orientation: "right",
                    autoclose: true
                });
                ...
                var InitController = function () {
                    ...
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_penduduk').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Penduduk',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Penduduk",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Penduduk',
                                data: {'id_penduduk': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_penduduk').val(data.results.id_penduduk);
                                        $('#nik').val(data.results.nik);
                                        $('#nama_penduduk').val(data.results.nama_penduduk);
                                        $('#tempat_lahir').val(data.results.tempat_lahir);
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Penduduk : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Penduduk',
                                                data: {'id_penduduk': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        toastr.success(data.msgServer);
