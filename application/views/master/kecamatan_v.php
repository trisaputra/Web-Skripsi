                        ...
                        <div class="col-md-12">
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data Kecamatan
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_kecamatan" data-toggle="modal" class="btn btn-sm btn-circle btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_kecamatan" class="modal fade" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-detail">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="widget-box widget-color-red2">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title lighter smaller">Tambah Kecamatan</h4>
                                                        </div>
                                                        <hr>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    ...
                                                                                    <input type="text" id="nama_kecamatan" name="nama_kecamatan" class="form-control" autocomplete="off" placeholder="Masukkan Nama Kecamatan"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                ...
                var InitController = function () {
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_kecamatan').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Kecamatan',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Kecamatan",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Kecamatan',
                                data: {'id_kecamatan': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_kecamatan').val(data.results.id_kecamatan);
                                        $('#nama_kecamatan').val(data.results.nama_kecamatan);
                                        $('#maps_poly').val(data.results.maps_poly);
                                        $('#warna').val(data.results.warna);
                                        $('#tambah_kecamatan').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Kecamatan : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Kecamatan',
