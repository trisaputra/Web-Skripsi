                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_jabatan" data-toggle="modal" class="btn btn-sm btn-circle btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <div class="modal-body">
                                                    <div class="widget-box widget-color-red2">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title lighter smaller">Tambah Jabatan</h4>
                                                        </div>
                                                        <hr>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    ...
                                                                                    <input type="text" id="nama_jabatan" name="nama_jabatan" class="form-control" autocomplete="off" placeholder="Masukkan Nama Jabatan"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
